...
# ROS Jazzy Jalisco Install Script for Turtlebot 3
# status --> UNTESTED

# exit on error
exit -e

# Args: swapfile: bool, ROS_DOMAIN_ID: int
...
echo "Welcome to TurtleBoot ROS!"
echo "developed by @kmhswimgirl"

# make swapfile if RPi has <= 2GB RAM
...
#referesh pakage updates and install curl
